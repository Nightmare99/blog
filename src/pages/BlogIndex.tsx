        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1.3fr_1fr] lg:items-start lg:gap-16">
          ...
          <div>
            ...
            >
              <span
                className={cn(
                  "flex h-7 w-7 items-center justify-center border-2 border-void-line bg-void-raised font-bold text-signal-cyan shadow-brutal-sm"
                )}
              >
                &gt;_
              </span>
          ...
          {/* Right column: log stats readout, desktop only. Sticks in view
